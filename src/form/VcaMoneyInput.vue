        ...
        <div class="vca-input-label">
            <div class="vca-labeled-input-container">
                ...
                <div class="input-fields">
                    <input class="left" type="number" v-model="money_data.unit" :placeholder="0" :min="min" :class="css" @input="changeUnit" @blur="validate" @change="change" />

                    <span class="middle" :class="css">,</span>
                    <input class="middle" type="number" v-model="money_data.subunit" placeholder="00" :min="0" :class="css" @change="change" @blur="validate" @input="changeSubUnit" />
...
export default {
    ...
    methods: {
        ...
        change() {
            this.$emit("input", { amount: Money.getValue(this.money_data), currency: this.money_data.currency });
        },
        changeSubUnit() {
