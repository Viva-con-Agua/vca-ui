<template>
  <div class="info-box">
    <div class="desktop">
      <div class="info-icon">
        <img @mouseenter="hovered = true, textRendered = true"
    ...
    <div class="mobile">
      <div class="info-icon">
        <img v-on:click="hovered = !hovered, textRendered = true"
             src="data:image/png;base64,">
      </div>
      <div class="info-text-wrap">
...
export default {
  ...
  computed: {
    classObject: function () {
      return {
        'not-rendered': !this.textRendered,
        'hide': !this.hovered,
  ...
  mounted() {
    this.$nextTick(function () {
          ...
          var el = this.$el.children[child].lastElementChild; //text-wrap
          var rect = el.getBoundingClientRect();

          if (rect.bottom + window.pageYOffset + spaceVertical > (document.body.clientHeight)) {
            if (rect.right + window.pageXOffset + spaceHorizontal > (document.body.clientWidth)) {
              this.setTopLeft();
            } else {
              this.setTopRight();
            }
