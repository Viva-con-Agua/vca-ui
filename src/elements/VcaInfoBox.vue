...
export default {
  ...
  mounted() {
    this.$nextTick(function () {
          ...
          /* eslint-disable no-console */
          console.log(rect.bottom + window.pageYOffset);

          if (rect.bottom + window.pageYOffset + 100 > (document.body.clientHeight)) {
            if (rect.right + window.pageXOffset + 400 > (document.body.clientWidth)) {
              this.setTopLeft();
            } else {
              this.setTopRight();
            }
